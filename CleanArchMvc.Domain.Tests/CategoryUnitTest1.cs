...
namespace CleanArchMvc.Domain.Tests
{
    public class CategoryUnitTest1
    {
        ...
        public void CreateCategory_WihtValidParameters_ResultObjectValidState()
        {
        ...
        public void CreateCategory_NegativeIdValue_DomainExeceptionInvalidId()
        {
            ...
            action.Should()
                ...
                .WithMessage("Invalid Id Value"); //TODO RMB: the message we expect by Domain 
        }

        [Fact(DisplayName = "Create Category With Short Name")]
        public void CreateCategory_ShortNameValue_DomainExeceptionShortName()
        {
        ...
        public void CreateCategory_WithNullNameValue_DomainExeceptionInvalidName()
        {
